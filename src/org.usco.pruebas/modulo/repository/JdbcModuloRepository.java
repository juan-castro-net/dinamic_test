...
public class JdbcModuloRepository implements ModuloRepository {
	...
	String CREATE_SQL = "INSERT INTO public.modulo"
		+ "(nombre, descripcion, estado, url)"
		+ "VALUES (?, ?, ?, ?)";

	String READ_SQL = "SELECT id, nombre, descripcion, estado, url"
		+ " FROM public.modulo";

	String UPDATE_SQL = "UPDATE public.modulo"
		+ " SET nombre=?, descripcion=?, estado=?, url=?"
		+ " WHERE id=?";
	...
	public int create(Modulo modulo) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { modulo.getId(), modulo.getNombre(), modulo.getDescripcion(), modulo.getEstado(), modulo.getUrl() });
	}
	...
	public int update(int id, Modulo modulo) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { modulo.getId(), modulo.getNombre(), modulo.getDescripcion(), modulo.getEstado(), modulo.getUrl(), id });
	}
