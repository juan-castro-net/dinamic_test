...
public class JdbcUsuarioRepository implements UsuarioRepository {
	...
	public int create(Usuario usuario) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { usuario.getId(), usuario.getLogin_username(), usuario.getPersona(), usuario.getEstado() });
	}
	...
	public int update(int id, Usuario usuario) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { usuario.getId(), usuario.getLogin_username(), usuario.getPersona(), usuario.getEstado(), id });
	}
