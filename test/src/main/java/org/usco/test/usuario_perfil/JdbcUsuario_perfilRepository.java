...
public class JdbcUsuario_perfilRepository implements Usuario_perfilRepository {
	...
	public int create(Usuario_perfil usuario_perfil) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { usuario_perfil.getUsuario(), usuario_perfil.getPerfil(), usuario_perfil.getEstado() });
	}
	...
	public int update(int id, Usuario_perfil usuario_perfil) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { usuario_perfil.getUsuario(), usuario_perfil.getPerfil(), usuario_perfil.getEstado(), id });
	}
