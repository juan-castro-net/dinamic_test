	...
	public ResponseEntity<String> createPersona(@RequestBody Persona persona) {
		try {
			personaRepository.create(
					new Persona(persona.getTipo_identificacion(), persona.getIdentificacion(), persona.getNombre(), persona.getApellido(), persona.getGenero(), persona.getFecha_nacimiento(), persona.getEstrato(), persona.getDireccion(), persona.getEmail_personal(), persona.getCelular(), persona.getEstado()));
