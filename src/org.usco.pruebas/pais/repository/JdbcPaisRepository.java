...
public class JdbcPaisRepository implements PaisRepository {
	...
	public int create(Pais pais) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { pais.getId(), pais.getNombre(), pais.getCodigo(), pais.getAcronimo() });
	}
	...
	public int update(int id, Pais pais) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { pais.getId(), pais.getNombre(), pais.getCodigo(), pais.getAcronimo(), id });
	}
