...
public class JdbcPermisosRepository implements PermisosRepository {
	...
	public int create(Permisos permisos) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { permisos.getPerfil(), permisos.getModulo(), permisos.getTipo_permiso() });
	}
	...
	public int update(int id, Permisos permisos) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { permisos.getPerfil(), permisos.getModulo(), permisos.getTipo_permiso(), id });
	}
