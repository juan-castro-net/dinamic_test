...
public class JdbcDepartamentoRepository implements DepartamentoRepository {
	...
	public int create(Departamento departamento) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { departamento.getId(), departamento.getNombre(), departamento.getPais(), departamento.getCodigo(), departamento.getAcronimo() });
	}
	...
	public int update(int id, Departamento departamento) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { departamento.getId(), departamento.getNombre(), departamento.getPais(), departamento.getCodigo(), departamento.getAcronimo(), id });
	}
