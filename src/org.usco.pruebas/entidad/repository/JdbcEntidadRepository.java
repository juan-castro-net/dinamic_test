...
public class JdbcEntidadRepository implements EntidadRepository {
	...
	public int create(Entidad entidad) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { entidad.getId(), entidad.getNombre(), entidad.getMunicipio(), entidad.getCodigo(), entidad.getTipoentidad(), entidad.getEstado(), entidad.getComuna(), entidad.getGeolocalizacion() });
	}
	...
	public int update(int id, Entidad entidad) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { entidad.getId(), entidad.getNombre(), entidad.getMunicipio(), entidad.getCodigo(), entidad.getTipoentidad(), entidad.getEstado(), entidad.getComuna(), entidad.getGeolocalizacion(), id });
	}
