...
public class JdbcEstadoRepository implements EstadoRepository {
	...
	public int create(Estado estado) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { estado.getId(), estado.getNombre(), estado.getDescripcion() });
	}
	...
	public int update(int id, Estado estado) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { estado.getId(), estado.getNombre(), estado.getDescripcion(), id });
	}
