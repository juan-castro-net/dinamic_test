...
public class JdbcPerfilRepository implements PerfilRepository {
	...
	public int create(Perfil perfil) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { perfil.getId(), perfil.getNombre(), perfil.getDescripcion(), perfil.getEstado(), perfil.getCodigo() });
	}
	...
	public int update(int id, Perfil perfil) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { perfil.getId(), perfil.getNombre(), perfil.getDescripcion(), perfil.getEstado(), perfil.getCodigo(), id });
	}
