package org.usco.test.municipio;
...
public class JdbcMunicipioRepository implements MunicipioRepository {
	...
	public int create(Municipio municipio) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { municipio.getNombre(), municipio.getDepartamento(), municipio.getCodigo(), municipio.getAcronimo() });
	}
	...
	public int update(int id, Municipio municipio) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { municipio.getNombre(), municipio.getDepartamento(), municipio.getCodigo(), municipio.getAcronimo(), id });
	}
