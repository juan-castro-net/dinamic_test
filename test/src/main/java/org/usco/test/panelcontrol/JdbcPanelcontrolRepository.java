...
public class JdbcPanelcontrolRepository implements PanelcontrolRepository {
	...
	public int create(Panelcontrol panelcontrol) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { panelcontrol.getNombre(), panelcontrol.getDescripcion(), panelcontrol.getEstado() });
	}
	...
	public int update(int id, Panelcontrol panelcontrol) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { panelcontrol.getNombre(), panelcontrol.getDescripcion(), panelcontrol.getEstado(), id });
	}
