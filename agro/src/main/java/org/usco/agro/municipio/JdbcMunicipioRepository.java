...
public class JdbcMunicipioRepository implements MunicipioRepository {
	...
	String CREATE_SQL = "INSERT INTO public.municipio"
		+ "(nombre, departamento_id, codigo, acronimo)"
		+ "VALUES (?, ?, ?, ?)";

	String READ_SQL = "SELECT id, nombre, departamento_id, codigo, acronimo"
		+ " FROM public.municipio";

	String UPDATE_SQL = "UPDATE public.municipio"
		+ " SET nombre=?, departamento_id=?, codigo=?, acronimo=?"
		+ " WHERE id=?";
	...
	public int create(Municipio municipio) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { municipio.getNombre(), municipio.getDepartamento_id(), municipio.getCodigo(), municipio.getAcronimo() });
	}
	...
	public int update(int id, Municipio municipio) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { municipio.getNombre(), municipio.getDepartamento_id(), municipio.getCodigo(), municipio.getAcronimo(), id });
	}
