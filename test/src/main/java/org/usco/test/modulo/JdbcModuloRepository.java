...
public class JdbcModuloRepository implements ModuloRepository {
	...
	public int create(Modulo modulo) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { modulo.getNombre(), modulo.getDescripcion(), modulo.getEstado(), modulo.getUrl() });
	}
	...
	public int update(int id, Modulo modulo) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { modulo.getNombre(), modulo.getDescripcion(), modulo.getEstado(), modulo.getUrl(), id });
	}
