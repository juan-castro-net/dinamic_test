...
public class JdbcSesionRepository implements SesionRepository {
	...
	public int create(Sesion sesion) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { sesion.getId(), sesion.getUsuario(), sesion.getFecha_hora_start(), sesion.getFecha_hora_end(), sesion.getIp() });
	}
	...
	public int update(int id, Sesion sesion) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { sesion.getId(), sesion.getUsuario(), sesion.getFecha_hora_start(), sesion.getFecha_hora_end(), sesion.getIp(), id });
	}
