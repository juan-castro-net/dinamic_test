package org.usco.pruebas.panelcontrol_menu;
...
public class JdbcPanelcontrol_menuRepository implements Panelcontrol_menuRepository {
	...
	public int create(Panelcontrol_menu panelcontrol_menu) {
		return jdbcTemplate.update(CREATE_SQL,
				new Object[] { panelcontrol_menu.getId(), panelcontrol_menu.getNombre() });
	}
	...
	public int update(int id, Panelcontrol_menu panelcontrol_menu) {
		return jdbcTemplate.update(UPDATE_SQL, new Object[] { panelcontrol_menu.getId(), panelcontrol_menu.getNombre(), id });
	}
